...
NetApp propose deux façons d’exécuter sa plateforme de gestion unifiée du stockage : NetApp Console et NetApp Console local deployment. Les deux partagent une base commune, mais diffèrent par leur architecture, leur connectivité, l’étendue de leurs fonctionnalités et leur modèle opérationnel. NetApp Console utilise des agents Console déployés dans votre environnement pour gérer les systèmes de stockage. NetApp Console local deployment est une machine virtuelle sans agent. NetApp Console local deployment communique directement avec les clusters ONTAP et offre des capacités de gestion de parc d’entreprise qui ne sont pas disponibles dans NetApp Console.
...
https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html["Découvrez les modes de déploiement de la NetApp Console"^].
...
link:https://docs.netapp.com/us-en/concept-netapp-console-local.html["Découvrez le déploiement local de la NetApp Console^."]
