...
summary: Avant de pouvoir ouvrir un ticket d’assistance auprès du support technique NetApp, vous devez ajouter un compte NetApp Support Site au déploiement local de NetApp Console, puis vous inscrire pour obtenir de l’assistance. 
---
