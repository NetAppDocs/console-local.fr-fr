...
summary: Découvrez comment le déploiement local de la NetApp Console s’intègre aux modèles OpenAI et compatibles OpenAI, y compris les décisions relatives au fournisseur et à la sécurité. 
---
