...
.Étapes
. Vérifiez que le bouton *Assistant Console* apparaît sur le tableau de bord de déploiement local de la NetApp Console.
. Ouvrez l'assistant en mode *Lecture seule* et exécutez une requête de base.
. Ouvrez l'assistant en mode *Lecture/écriture* et vérifiez que les actions modifiant le stockage nécessitent une confirmation de l'utilisateur avant leur exécution.
