...
Pour plus de détails sur la manière d'organiser les flottes, voir link:concept-manage-storage.html["Découvrez la gestion de flotte dans le déploiement local de NetApp Console"].
...
* Pour comprendre l'organisation de la flotte, voir link:concept-manage-storage.html["Découvrez la gestion de flotte dans le déploiement local de NetApp Console"].
* Pour créer des politiques et des classes de stockage, voir link:task-storage-class-manage.html["Gérer les classes de stockage et les politiques"].
...
* Pour analyser et corriger la dérive, voir link:task-storage-class-drift-remediate.html["Corriger la dérive de la classe de stockage"]
