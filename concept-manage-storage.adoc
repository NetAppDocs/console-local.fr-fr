...
Pour une présentation détaillée de la hiérarchie et du modèle d'accès, voir link:concept-folders-fleets-overview.html["Découvrez les dossiers et les flottes dans le déploiement local de la NetApp Console"].
...
* Pour comprendre les normes de stockage, voir link:concept-storage-classes.html["Découvrez les classes de stockage et les stratégies dans le déploiement local de la NetApp Console"].
* Pour créer et gérer des flottes, consultez link:task-iam-manage-folders-fleets.html["Gérer les dossiers et les flottes"].
