...
summary: Vous utilisez un fichier OVA pour installer un déploiement local de la NetApp Console dans votre vCenter. Le téléchargement ou l’URL du fichier OVA est disponible sur le site de support NetApp. 
---
