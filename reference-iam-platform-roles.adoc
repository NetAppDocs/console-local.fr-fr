...
| Configurez l'intégration LLM et activez l'assistant NetApp Console | Oui | Non 


| Configurer les paramètres de diffusion des notifications et du serveur de messagerie | Oui | Non 
|===
