...
.Étapes
. Sélectionnez *Administration > Console*.
. Sélectionnez *Configuration* pour ouvrir la page de configuration des systèmes.
. Dans la section *Serveur de messagerie*, sélectionnez *Configurer*.
. Sélectionnez *Effacer les champs* pour effacer la configuration existante.
. Sélectionnez *Enregistrer* pour sauvegarder la configuration effacée, ce qui supprime la configuration du serveur de messagerie du déploiement local de NetApp Console.
